...
<head>
    ...
    <title>Autorisations de sorties</title>
    <!--MATERIAL ICONS-->
...
<body> 
    ...
    <div class="container">
        ...
        <!---------END OF ASIDE------------>
        <main>
            <h1>Compteur des autorisations de sortie</h1>
            ...
            <div class="Insights">
                ...
                <div class="Collaborations">
                    ...
                    <div class="info">
                        <label> Vos absences prises :</label>
                        <span class="inf" id="                        <span class="inf" id="autoPrises">0</span>
</span>
                    </div>
                    
                    <button onclick="ajouterAbsence()">Ajouter une absence</button>
 ...
 <!---------END OF TOP------------>
    ...
    <script src="compt_abs.js"></script>
</body>
</html>