...
<head>
    ...
    />
    <title>Créer un nouveau personel</title>
    <!--MATERIAL ICONS-->
...
<body> 
    <div class="container">
        ...
        <!---------END OF ASIDE------------>
        <main>
            <h1>Créer un nouveau personnel</h1>
        ...
        <div class="right">
            ...
            <div class="info-container">
                <form action="createperso.php" method="POST">
                  
                    <div class="form first">
                        <div class="nouveau personal">
                            <span class="title">Nouveau personnel</span>
                            ...
                            <div class="input-field">
                                <label>Age</label>
                                    <input type="number" name="age"  placeholder="Entrer l'age" required>
                            </div>
                            <div class="input-field">
                                <label>Email</label>
                            ...
                            <div class="input-field">
                                <label>Téléphone</label>
                                    <input type="number"  name="tel" placeholder="Entrer le numero" required>
                            </div>
                            ...
                            <div class="fields">
                                ...
                                <div class="input-field">
                                    <label>Profession</label>
                                        <input type="text" name="profession"  placeholder="Entrer la profession" required>
                                </div>
                                <div class="input-field">
                                    <label>Type ID</label>
                                        <input type="text" name="type_id"  placeholder="Entrer le type ID" required>
                                </div>
                                <div class="input-field">
                                    <label>Numéro ID</label>
                                        <input type="number" name="num_id"  placeholder="Entrer le num ID" required>
                                </div>
                            </div>
                            ...
                            <div class="input-field">
                                ...
                                <div class="input-field">
                                    <label>Code postal</label>
                                        <input type="number" name="code_postal"  placeholder="Entrer le code" required>
                                </div>
